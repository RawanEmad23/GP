...
//     // profile_picture: Yup.mixed().required('Add Photo').test('fileSize', 'الحد الأقصى لحجم الملف هو 5MB', value => value && value.size <= 5242880).test('fileType', 'يجب أن تكون الصورة من نوع JPG أو PNG', value => value && (value.type === 'image/jpeg' || value.type === 'image/png'))
//   })
