...
//     axios
//     .post("https:youssifallam.pythonanywhere.com/api/user/resend-otp/" , emailuser)
//      .catch((err)=>{
...
//     otp: Yup.string()
//     .matches(/^[0-9]{1,4}$/,'enter valid otp')
...
//   <p className=' mt-3 '>Please enter the 4-digit code sent to your 
// email <a href="/contact.uiuxexperts@gmail.com">contact.uiuxexperts@gmail.com</a> for verification.</p>
...
//         <button type='submit' className=' button    design mb-4  mt-4  '>Vefify OTP</button>
//   </form>

// <p className=' fw-bold    '>Didn’t receive any code?  <span onClick={Resendcode}> Resend Again</span> </p>
  ...
  return (
    <div style={{ backgroundColor: '#0caed438', minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
      <div className='conta text-center'>
        <div className='d-flex flex-column justify-content-center align-item-center all'>
          <h2 className='fw-bold'>Almost there</h2>
          <p className='mt-3'>Please enter the 4-digit code sent to your email <a href="mailto:contact.uiuxexperts@gmail.com">contact.uiuxexperts@gmail.com</a> for verification.</p>
